#include <WebServer.h>
#include <WiFi.h>         //https://raw.githubusercontent.com/espressif/arduino-esp32/gh-pages/package_esp32_dev_index.json  "ESP32"
#include <esp32cam.h>    //https://github.com/yoursunny/esp32cam  LINK DE LA LIBRERIA SI SALE ERROR

//Instalar Python para usar "PIP" en M.S.
//https://www.youtube.com/watch?v=gm0gexHWDy0 Para activar Scrips en Microsoft estudio
...
const char* WIFI_SSID = "WifiDd";    //ID DE WIFI
const char* WIFI_PASS = "Dada1231"; //Contraseña d wifi
